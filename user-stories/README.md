Objective: Translate use case diagram interactions(use-case-diagram/alx-airbnb-uc.png) into user stories.
...
within your GitHub repository alx-airbnb-project-documentation and document your user stories there.
